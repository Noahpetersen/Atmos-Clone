...
const Experience = () => {
    ...
    return [
      {
        ...
        subTitle: `Welcome to Atmos, Have a seat and enjoy the flight!`
      }, 
      {
        cameraRailDist: 1.5,
        position: new THREE.Vector3(
  ...
  useFrame((state, delta) => {
    ...
    // Make the group look at the point curve
  ...
  return (
    <>
      ...
      <group ref={cameraGroup}> 
        ...
        {/* <AirplaneOld></AirplaneOld> */}
        <group ref={airplane}>
          <Float floatIntensity={1.2} speed={2} rotationIntensity={0.2}>
          <Airplane scale={0.0027} rotation-y={Math.PI / 1} position={[0.2, -0.3, 0]}/>
          </Float>
        </group>
      </group>
